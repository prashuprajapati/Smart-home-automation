...
import 'package:smarthome/src/screens/home_screen/components/music_widget.dart';
import 'package:smarthome/src/screens/home_screen/components/savings_container.dart';
import 'package:smarthome/src/screens/home_screen/components/weather_container.dart';
import 'package:smarthome/src/screens/set_event_screen/set_event_screen.dart';
import 'package:smarthome/src/screens/smart_ac/smart_ac.dart';
import 'package:smarthome/src/screens/smart_fan/smart_fan.dart';
import 'package:smarthome/src/screens/smart_light/smart_light.dart';
import 'package:smarthome/src/screens/smart_speaker/smart_speaker.dart';
import 'package:smarthome/view/home_screen_view_model.dart';
import 'package:smarthome/src/screens/smart_tv/smart_tv.dart';
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: DarkContainer(
                      ...
                      device: 'Lightening',
                      deviceCount: '0 lamps is conected',
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: DarkContainer(
                      ...
                      device: 'AC',
                      deviceCount: '0 devices is connected',
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: DarkContainer(
                      ...
                      device: 'Speaker',
                      deviceCount: '0 device is connected',
