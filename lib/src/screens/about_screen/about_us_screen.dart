      ...
      children: [
        ...
        Padding(
          ...
          child: Center(child: Column(
            children: const [
              Text('Smart_home_automation',style: TextStyle(fontFamily: 'Lexend',
                fontSize: 48,
        ...
        ListTile(
          ...
          subtitle: const Text('smart_team',
          style: TextStyle(
            fontSize: 14,
            fontFamily: 'Lexend',
            fontWeight: FontWeight.w300
        ...
        ListTile(
          ...
          subtitle: const Text('People and open source projects that helped the development',
            style: TextStyle(
                fontSize: 14,
              fontFamily: 'Lexend',
            ),),
        ...
        ListTile(
          ...
          subtitle: const Text('Follow on social networks',
            style: TextStyle(
                fontSize: 14,
              fontFamily: 'Lexend',
            ),),
